...
{
    /// <summary>
    /// This is a copied class from stackoverflow. :) 
    /// <para></para>Everything after this text is not from the Author of EDLibrary. Except of <seealso cref="Keyboard.exec(DirectXKeyStrokes[])"/>
    /// 
    /// 
    /// <para>My own question as reference: https://stackoverflow.com/questions/35138778/sending-keys-to-a-directx-game
